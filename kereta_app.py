...
with tab2:
    ...
    # Membagi tampilan daftar menjadi 2 kolom agar seimbang di layar besar
...
# ==================== MENU 3: KELOLA PETA ====================
with tab3:
    st.subheader("⚙️ Tambah Hubungan Rel Baru")
    st.write("Gunakan menu ini untuk menambahkan stasiun baru ke dalam peta secara dinamis.")
    ...
    with col_in2:
        st.markdown("""
        ### 💡 Petunjuk Pengujian Dinamis:
        1. Ketik stasiun baru di kolom kiri (Misal: Asal: `Surabaya`, Tujuan: `Banyuwangi`, Jarak: `290`).
        2. Klik **Simpan Data Rute**.
        3. Pindah ke Menu **📍 Cari Rute Terpendek**, kota `Banyuwangi` akan otomatis terdaftar di pilihan sistem pencarian!
        """)
